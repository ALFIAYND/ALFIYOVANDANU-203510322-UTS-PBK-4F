<script setup>
import HelloWorld from './components/ALFIYOVANDANU_203510322_UTS_PBK_4F.vue.vue'
</script>
...
<template>
  ...
  <HelloWorld msg="ALFIYOVANDANU" />
</template>


<style scoped>
/* Warna latar belakang untuk div utama */
div {
...
/* Warna latar belakang untuk baris tabel saat dihover */
tr:hover {
...
/* Gaya untuk tombol di dalam div card */
.card button {
  margin-right: 10px;
}
